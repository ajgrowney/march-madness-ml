...
for year in [2019, 2022]:
    ...
    ts_df = team_seasons_to_df(ts, FEATURE_COLUMNS)
    full_df = pd.concat([full_df, ts_df], ignore_index=True)
full_df.to_csv(f"TeamSeasons.csv", index=False)